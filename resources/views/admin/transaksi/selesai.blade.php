                    ...
                    <div class="box-body">
                        ...
                        <div class="btn-group btn-group-justified" style="margin-bottom: 10px" role="group"
                            ...
                            <div class="btn-group" role="group">
                                <a href="{{ route('transaksi') }}" class="btn btn-default">Baru</a>
                            </div>
                            <div class="btn-group" role="group">
                                <a href="{{ route('transaksiMainProses') }}" class="btn btn-default">Proses</a>
                            </div>
                            <div class="btn-group" role="group">
                                <a href="{{ route('transaksiMainSelesai') }}" class="btn btn-primary">Selesai</a>
                            </div>
                            <div class="btn-group" role="group">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" style="">
                                                    ...
                                                    @if ($us->status_pembayaran == 'Belum Dibayar')
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('transaksiBayar', $us->id_transaksi) }}"><i
                                                                    class="fa fa-print" style="margin-right: 5px"></i>Bayar</a>
                                                        </li>
                                                    @endif
                                                    ...
                                                    @endif
                                                    <li>
                                                        <a class="dropdown-item hapusTra" href="#"
