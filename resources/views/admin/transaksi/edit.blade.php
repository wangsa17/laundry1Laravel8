        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="post" action="{{ route('transaksiUpdate') }}">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select name="outlet" id="outlet" class="form-control">
                                    ...
                                    @foreach ($outlet as $out)
                                        <option value="{{ $out->id_outlet }}" {{($out->id_outlet == $transaksi->outlet_id) ? 'selected' : ''}} >{{ $out->nama }} ({{ $out->alamat }})</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="paket" id="paket" class="form-control">
                                    ...
                                    @foreach ($paket as $pak)
                                        <option value="{{ $pak->id_paket }}" {{($pak->id_paket == $transaksi->paket_id) ? 'selected' : ''}}>{{ $pak->nama_paket }} ({{ $pak->deskripsi }}) Rp. {{ $pak->harga }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" value="{{(old('qty')) ? old('qty') : $transaksi_detail->qty}}" name="berat" class="form-control">
